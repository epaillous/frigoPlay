...
ContentFlow.prototype = {
	...
	setConfig: function (A) {
		...
		case this.conf.reflectionColor.search(/#[0-9a-fA-F]{6}/) >= 0 ? this.conf.reflectionColor: this.conf.reflectionColor + "x": this._reflectionColorRGB = {
